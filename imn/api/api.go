...
var (
	...
	GetMinerStatus func() *IMNMinerStatus
	GetMiners      func(node string, timeout int) []*IMNMinerStatus
...
func (s *IMNMinerStatus) Clone() *IMNMinerStatus {
	return &IMNMinerStatus{
		NodeName:          s.NodeName,
		Enode:             s.Enode,
		Id:                s.Id,
		Addr:              s.Addr,
...
func SubscribeToMinerStatus(ch chan *IMNMinerStatus) event.Subscription {
...
func GotStatusEx(status *IMNMinerStatus) {

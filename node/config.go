...
func DefaultIPCEndpoint(clientIdentifier string) string {
	...
	config := &Config{DataDir: DefaultDataDir(), IPCPath: "gimn.ipc"}
...
func (c *Config) NodeName() string {
	...
	if name == "geth" || name == "geth-testnet" || name == "gimn" || name == "gimn-testnet" {
		name = "Gimn"
	}
	if c.UserIdent != "" {
		name += "/" + c.UserIdent
...
func (c *Config) name() string {
	if c.Name == "" {
		...
		if strings.EqualFold(c.Name, "gimn") {
			progname = "geth"
		}
		return progname
	} else if strings.EqualFold(c.Name, "gimn") {
		return "geth"
	}
	return c.Name
}
